...
export class MyPluginSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl).setHeading().setName("Advanced"); // Sentence case, no "settings"
...
// Dropdown
new Setting(containerEl).setName("Choose option").addDropdown((dropdown) =>
	dropdown
...
new Setting(containerEl).setName("Template file").addSearch((search) =>
	search
